...
const Home = () => {
  const {getUserProfiles,userProfiles,isLoadingUserProfiles,subscribeToNewMatches, unsubscribeToNewMatches} = useMatchStore();
  ...
  useEffect(() => {
    ...
    return () => unsubscribeToNewMatches();
  },[subscribeToNewMatches,unsubscribeToNewMatches,authUser]);

  // console.log(userProfiles);
  return (
    <div className="flex flex-col lg:flex-row min-h-screen bg-gradient-to-br from-pink-100 to bg-purple-100 overflow-hidden">
      <Sidebar />
