...
import { MessageCircle, X,Loader, Heart } from "lucide-react";
import { Link } from "react-router-dom";
import { useMatchStore } from "../Store/useMatchStore";
const Sidebar = () => {
  const [isOpen, setIsOpen] = useState(false);
//   const matches = [{ _id: "1", name: "Jen" }];
  ...
  return (
    ...
    <button className="lg:hidden fixed top-4 p-2 bg-pink-500 text-white rounded-md z-0"
    onClick={toggleSidebar}>
